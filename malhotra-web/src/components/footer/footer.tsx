        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a title="Instagram" href="#" className="text-white hover:text-secondary transition-colors">
                <Instagram className="h-6 w-6" />
              </a>
              <a title="Twitter" href="#" className="text-white hover:text-secondary transition-colors">
                <Twitter className="h-6 w-6" />
              </a>
              <a title="Facebook" href="#" className="text-white hover:text-secondary transition-colors">
                <Facebook className="h-6 w-6" />
              </a>
              <a title="LinkedIn" href="#" className="text-white hover:text-secondary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/products/data-communication" className="text-gray-300 hover:text-white">
                  Data Communication Cables
                </Link>
              </li>
              <li>
                <Link href="/products/high-voltage" className="text-gray-300 hover:text-white">
                  High-Voltage Cables
                </Link>
              </li>
              <li>
                <Link href="/products/custom" className="text-gray-300 hover:text-white">
                  Custom Solutions
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">123 Industrial Area, Delhi NCR, India - 110001</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">info@malhotracables.com</span>
              </li>
            </ul>
          </div>
        </div>
