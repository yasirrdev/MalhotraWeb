    ...
    return (
      ...
      >
        <div className="relative">
          ...
          >
            <Button className="bg-accent hover:bg-accent/90 text-white rounded-full px-6" asChild>
              <Link href={`/products/${slugify(cable.category)}/${slugify(cable.name)}`}>
                Details
        ...
        <div className="p-4">
          <h3 className="font-semibold text-gray-900 mb-3 line-clamp-2 h-12">{cable.name}</h3>

          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              <span className="text-gray-500">Cable Type:</span>
              <span className="text-gray-900 font-medium">{cable.cableType}</span>
            </div>

            <div className="flex justify-between">
              <span className="text-gray-500">Insulation:</span>
              <span className="text-gray-900 font-medium">{cable.insulationMaterial}</span>
            </div>

            <div className="flex justify-between">
              <span className="text-gray-500">Temp Range:</span>
              <span className="text-gray-900 font-medium">{cable.temperatureRange}</span>
            </div>

            <div className="flex justify-between">
              <span className="text-gray-500">Standard:</span>
              <span className="text-gray-900 font-medium">{cable.referenceStandard}</span>
            </div>
          </div>
        </div>
      </div>
